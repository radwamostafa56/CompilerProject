...
namespace CompilerProject.Forms
{
    public partial class FormScanner : Form
    {
        ...
        {
            Keyword, Identifier, Number, Operator, RelationalOperator, Assign, LeftParenthesis, RightParenthesis, LeftBrace, RightBrace, Whitespace, Semicolon
        }
        ...
        public class Scanner
        {
            ...
            public List<Token> Scan(string code)
            {
                ...
                foreach (Match match in Patterns.Matches(code))
                {
                    ...
                    else if (match.Groups["RelationalOperator"].Success)
                        tokens.Add(new Token(TokenType.RelationalOperator, match.Value));
